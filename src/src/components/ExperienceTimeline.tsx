...
export function ExperienceTimeline({ internships, experience }: ExperienceTimelineProps) {
  ...
  const TimelineItem = ({ item, index }: { item: ExperienceItem; index: number }) => (
    ...
    >
      {/* Timeline line */}
      <div className="absolute left-0 top-0 bottom-0 w-0.5 bg-gradient-to-b from-blue-600 to-blue-700" />
      
      {/* Timeline dot */}
      <div className="absolute left-0 top-0 w-4 h-4 -ml-[7px] rounded-full bg-blue-600 border-4 border-white" />
